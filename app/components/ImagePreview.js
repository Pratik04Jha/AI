...
const ImagePreview = (props) => {
  ...
  return (
    <div className="flex justify-center h-screen pb-15 text-white">
      <div className="h-[90%] mt-3 w-full flex justify-center items-center gap-5">
        
        {/* Uploaded Image */}
        <div
          className="h-[100%] w-100 bg-zinc-800 rounded-lg overflow-hidden relative"
